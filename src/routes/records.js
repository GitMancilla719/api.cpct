...
} = require('../controllers/helpers/validators/records/add_record_validator')
const {
  deleteRecordValidator,
  deleteRecordValidationResult,
} = require('../controllers/helpers/validators/records/delete_record_validator')
const {
  updateRecordValidator,
  updateRecordValidationResult,
} = require('../controllers/helpers/validators/records/update_record_validator')
...
router.get('/', records.get_all_records)
router.get('/:location', records.get_by_location)
