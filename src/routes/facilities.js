...
const { addFacilitiesValidator, addFacilitiesValidationResult } = require('../controllers/helpers/validators/facilities/add_facilities_validator')
const { deleteFacilitiesValidator, deleteFacilitiesValidationResult } = require('../controllers/helpers/validators/facilities/delete_facilities_validator')
const { updateFacilitiesValidator, updateFacilitiesValidationResult } = require('../controllers/helpers/validators/facilities/update_facilities_validator')
